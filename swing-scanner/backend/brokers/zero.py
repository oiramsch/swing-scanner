"""
Zero (Finanzen.net Zero) broker connector — manual checklist execution.
No official API available. Execution via Zero Web/App.
Fee model: 0 € pro Trade (kostenlos, kein Minimum).
"""
...
class ZeroConnector(BrokerConnector):
    broker_type = "zero"
    currency = "EUR"
    ...
    def place_order(self, plan: dict) -> dict:
        raise NotImplementedError(
            "Zero: Bitte den Trade manuell über die Zero-App ausführen. "
    ...
    def get_execution_checklist(
        ...
        steps = [
            "Zero App oder Web öffnen (zero.finanzen.net)",
